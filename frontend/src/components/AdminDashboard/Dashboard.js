...
const AdminDashboard = () => {
  ...
  return (
    <div className="container mt-5">
      <Navbar />
      <h2 className="text-center title">Welcome to the Admin Dashboard</h2>
      <p className="text-center subtitle">Here you will see overall employee performance metrics.</p>
